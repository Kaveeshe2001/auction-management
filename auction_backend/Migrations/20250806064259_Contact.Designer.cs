...
namespace auction_backend.Migrations
{
    ...
    [Migration("20250806064259_Contact")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("auction_backend.Models.Art", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("auction_backend.Models.Contactus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("auction_backend.Models.Store", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("auction_backend.Models.Art", b =>
                {
                    ...
                    b.HasOne("auction_backend.Models.Store", "Store")
                        .WithMany("Arts")
            ...
            modelBuilder.Entity("auction_backend.Models.Auction", b =>
                {
                    b.HasOne("auction_backend.Models.Art", "Art")
                        .WithOne("Auction")
                        .HasForeignKey("auction_backend.Models.Auction", "ArtId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("auction_backend.Models.Store", b =>
                {
                    b.HasOne("auction_backend.Models.User", "User")
                        .WithOne("Store")
                        .HasForeignKey("auction_backend.Models.Store", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
